...
- [Terraform on Microsoft Azure - Part 6: Continuous integration using Azure Pipeline](https://blog.jcorioland.io/archives/2019/09/25/terraform-microsoft-azure-ci-docker-azure-pipeline.html)
- [Terraform on Microsoft Azure - Part 7: Continuous deployment using Azure Pipeline](https://blog.jcorioland.io/archives/2019/10/02/terraform-microsoft-azure-pipeline-continuous-deployment.html)
