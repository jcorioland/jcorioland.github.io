...
Another way to see this post is: *A brain dump of architecture design and best practices to build a cloud native platform on top of Azure Kubernetes Service*.
